...
static inline float16_t float32_to_float16(float value) {
    //printf("Using AVX512F for float32 to float16 conversion\n");
...
static inline float float16_to_float32(float16_t value) {
    //printf("Using AVX512F for float16 to float32 conversion\n");
...
static inline float16_t float32_to_float16(float value) {
    //printf("Using NEON for float32 to float16 conversion\n");
...
static inline float float16_to_float32(float16_t value) {
    //printf("Using NEON for float16 to float32 conversion\n");
...
static inline uint16_t float32_to_float16(float value) {
    //printf("Using software implementation for float32 to float16 conversion\n");
...
#endif // End of hardware-specific implementations
